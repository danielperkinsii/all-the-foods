                    ...
                    {restaurant.dishes.map((res) => (
                        <div className="flex flex-row justify-between py-3 border-b" key={res.id}>
                            <div className="mx-auto my-auto">
                                <img className="h-48 w-64 object-cover" top={true} src={`${process.env.NEXT_PUBLIC_API_URL}${res.image.url}`}/>
                            </div>
                            ...
                            <div className="footer">
                                <button className="border rounded-lg py-2 px-3 bg-gray-200 hover:bg-white text-blue-500">
                                    + Add To Cart
                                </button></div>
                            </div>
                        ))}
